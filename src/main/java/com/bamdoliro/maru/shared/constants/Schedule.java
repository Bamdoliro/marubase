...
public class Schedule {
    ...
    public static final LocalDateTime ANNOUNCEMENT_OF_FIRST_PASS = LocalDateTime.of(2025, 9, 26, 2, 5);
    ...
    public static final String SELECT_FIRST_PASS_CRON = "0 0 2 26 9 ?";
