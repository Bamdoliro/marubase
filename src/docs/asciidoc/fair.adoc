...
===== Request Cookie
include::{snippets}/admin-fair-controller-test/입학설명회_일정을_만든다/request-cookies.adoc[]

===== Request Body
include::{snippets}/admin-fair-controller-test/입학설명회_일정을_만든다/request-fields.adoc[]

===== 요청
include::{snippets}/admin-fair-controller-test/입학설명회_일정을_만든다/http-request.adoc[]

==== 응답

===== 정상 응답
include::{snippets}/admin-fair-controller-test/입학설명회_일정을_만든다/http-response.adoc[]
...
===== Request Cookie
include::{snippets}/admin-fair-controller-test/입학설명회를_상세히_불러온다/request-cookies.adoc[]

===== Path Parameter
include::{snippets}/admin-fair-controller-test/입학설명회를_상세히_불러온다/path-parameters.adoc[]

===== 요청
include::{snippets}/admin-fair-controller-test/입학설명회를_상세히_불러온다/http-request.adoc[]

==== 응답

===== 정상 응답
include::{snippets}/admin-fair-controller-test/입학설명회를_상세히_불러온다/http-response.adoc[]

===== 입학설명회가 없는 경우
include::{snippets}/admin-fair-controller-test/입학설명회를_상세히_불러올_때_해당_입학설명회가_없으면_에러가_발생한다/http-response.adoc[]
...
===== Request Cookie
include::{snippets}/admin-fair-controller-test/입학설명회_신청자_명단을_엑셀로_다운받는다/request-cookies.adoc[]

===== Path Parameter
include::{snippets}/admin-fair-controller-test/입학설명회_신청자_명단을_엑셀로_다운받는다/path-parameters.adoc[]

===== 요청
include::{snippets}/admin-fair-controller-test/입학설명회_신청자_명단을_엑셀로_다운받는다/http-request.adoc[]

==== 응답

===== 정상 응답
include::{snippets}/admin-fair-controller-test/입학설명회_신청자_명단을_엑셀로_다운받는다/http-response.adoc[]
