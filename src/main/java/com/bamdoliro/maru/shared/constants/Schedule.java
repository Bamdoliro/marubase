...
public class Schedule {
    ...
    public static final LocalDateTime ANNOUNCEMENT_OF_FIRST_PASS = LocalDateTime.of(2025, 9, 26, 2, 50);
    ...
    public static final String SELECT_FIRST_PASS_CRON = "0 25 10 26 9 ?";
