...
===== Request Header
[snippets/question-controller-test/자주묻는질문을_수정한다/request-headers.adoc]
include::{snippets}/question-controller-test/자주묻는질문을_수정한다/request-headers.adoc[]

===== Request Body
[snippets/question-controller-test/자주묻는질문을_수정한다/request-fields.adoc]
include::{snippets}/question-controller-test/자주묻는질문을_수정한다/request-fields.adoc[]

==== 요청
[snippets/question-controller-test/자주묻는질문을_수정한다/http-request.adoc]
include::{snippets}/question-controller-test/자주묻는질문을_수정한다/http-request.adoc[]

===== 정상 응답
[snippets/question-controller-test/자주묻는질문을_수정한다/http-response.adoc]
