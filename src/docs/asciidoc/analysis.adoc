...
==== Request Cookie
include::{snippets}/analysis-controller-test/전형별_지원자수를_조회한다/request-cookies.adoc[]
...
==== Request Cookie
include::{snippets}/analysis-controller-test/_1차_합격자들의_성적_분포를_조회한다/request-cookies.adoc[]
...
==== Request Cookie
include::{snippets}/analysis-controller-test/전형별_성비를_조회한다/request-cookies.adoc[]
...
==== Request Cookie
include::{snippets}/analysis-controller-test/부산_특정구_출신_지원자들의_출신학교_통계를_조회한다/request-cookies.adoc[]
